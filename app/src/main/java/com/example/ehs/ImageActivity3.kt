...
class ImageActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /************* Php script path  */
        upLoadServerUri = "http://54.180.101.123/upload.php"
...
//            imageToDB(bmpimg)
    ...
    private fun imageToDB(image: String) {
        val responseListener: Response.Listener<String?> = object : Response.Listener<String?> {
            ...
            override fun onResponse(response: String?) {
                try {
                    ...
                    if (success) {
                        Toast.makeText(this@ImageActivity3, "저장성공", Toast.LENGTH_SHORT).show()
        ...
        val queue = Volley.newRequestQueue(this@ImageActivity3)
            ...
            try {
                ...
                if (serverResponseCode == 200) {
                    runOnUiThread {
                        ...
                        Toast.makeText(this@ImageActivity3, "File Upload Complete.", Toast.LENGTH_SHORT).show()
                    }
                }
